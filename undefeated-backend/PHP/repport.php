  ...
  <html>
    ...
    <body>
      <div class="container"><br/>
        <h2 align="center" style=color:#dc3545><b>Let\'s Find what you are looking for 👁 </b></h2><br />
        <!-- Search form -->
        <div class="md-form mt-0">
          <input class="form-control" type="text" placeholder="Search here.." aria-label="Search" name="search_text" id="search_text" >
        </div>
      </div><br />
      <div id="result"></div>
    </div>';
    ...
    <div class='col-lg-12 col-md-6 Tickets'>
      <h4 style='font-weight:500'>Ticket Reserved</4><br><br>
    ...
    while($row=mysqli_fetch_assoc($res2)){
      ...
      echo"<tbody>
        <tr>
          ...
          <a href='modification?id=".$row['id']."'><button class='btn btn-primary'>Modify</button></a></td>
          <td class='text-center'> <a href='supp.php?id=".$row['id']."'><button class='btn btn-danger'>Delete</button></a></td>
      ";
      echo "<td  class='text-center'> <img src='$final' style=' width:40px; height:40px'>  </td>
        </tr>
      </tbody>";
    };
    echo "</table>
